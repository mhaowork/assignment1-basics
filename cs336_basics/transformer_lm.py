...
class TransformerLM(nn.Module):
    def __init__(
        ...
        self.input_embedding.load_state_dict({"W": weights["token_embeddings.weight"]})
        ...
        self.transformer_blocks = [
            TransformerBlock(
                ...
                theta=rope_theta,
                weights=weights,
                weight_key_prefix=f"layers.{idx}.",
            )
        ...
        self.rmsnorm_final.load_state_dict({"gain": weights["ln_final.weight"]})
